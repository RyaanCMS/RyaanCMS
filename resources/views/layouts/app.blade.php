...
<div class="flex h-screen overflow-hidden">
    ...
    <aside class="app-sidebar {{ $sidebarAutoHide ? 'sidebar-autohide' : '' }}"
        ...
        <div style="padding:8px;border-top:1px solid var(--border);flex-shrink:0;" x-data="{ open: false }">
            ...
            {{-- Profile popup: position:fixed escapes the sidebar's overflow:hidden --}}
            <div x-show="open"
                 ...
                 style="position:fixed;bottom:68px;left:8px;width:232px;background:var(--surface-base);border:1px solid var(--border);border-radius:12px;box-shadow:var(--shadow-lg);overflow:hidden;z-index:100;padding:4px 0;">
                <div style="padding:10px 14px 8px;border-bottom:1px solid var(--border);">
                    ...
                    <div style="font-size:11px;color:var(--text-3);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;margin-top:1px;">{{ auth()->user()->email }}</div>
                </div>
